			...
			<div class="modal-body">
				<form>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="view-description" class="form-control" placeholder="Title of the review" maxlength="100"  disabled/>
					</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="view-reviewee" class="form-control" placeholder="Name of reviewee" maxlength="100" disabled>
					</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="view-num-reviewers" class="col-md-4 form-control" placeholder="0" maxlength="5" disabled>
					</div>
					...
					<div class="row mb-2">
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="view-date-start" placeholder="yyyy-mm-dd" disabled autocomplete="off">
							</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="view-time-start" placeholder="HH:mm" disabled autocomplete="off">
							</div>	
					...
					<div class="row mb-2">
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="view-date-end" placeholder="yyyy-mm-dd" disabled autocomplete="off">
							</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="view-time-end" placeholder="HH:mm" disabled autocomplete="off">
							</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="view-reviewFee-vsu" maxlength="15" class="form-control" placeholder="VSU graduate" disabled>
					</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="view-reviewFee-nonVsu" maxlength="15" class="form-control" placeholder="Non-VSU graduate" disabled>
					</div>
