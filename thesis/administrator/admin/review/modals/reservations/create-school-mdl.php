				...
				<div class="col-md-10 offset-md-1">
					<form>
						<div class="input-group">
							...
							<input type="text" id="addSchool" class="form-control" maxlength="50">
						</div>
						...
						<div class="input-group mt-2">
							...
							<input type="text" id="addSchoolAddress" class="form-control" maxlength="100">
						</div>
						<div id="addSchoolAddress-msg" class="ml-3"></div>
