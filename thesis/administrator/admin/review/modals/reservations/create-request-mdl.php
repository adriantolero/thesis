			...
			<form>
				...
				<div class="modal-body">
					...
					<div class="input-group">
						...
						<input type="text" id="request-fname" class="form-control col-md-4" placeholder="First name" maxlength="50">
						<input type="text" id="request-mi" class="form-control col-md-2" placeholder="M.I" maxlength="2">
						<input type="text" id="request-lname" class="form-control col-md-4" placeholder="Last name" maxlength="50">
					</div>
					...
					<div class="input-group mt-2">
						...
						<input type="text" id="request-bdate" placeholder="Birth date" class="form-control col-md-5">
					</div>
					...
					<div class="input-group mt-2">
						...
						<input type="text" id="request-address" placeholder="Address" class="form-control" maxlength="50">
					</div>
					...
					<div class="input-group mt-2">
						...
						<input type="text" id="request-contact" placeholder="Mobile" class="form-control col-md-4" maxlength="30">
					</div>
					...
					<div class="input-group mt-2">
						...
						<input type="text" id="request-email" class="form-control" maxlength="50" placeholder="Email Address">
					</div>
					...
					<div class="input-group mt-2">
						...
						<div class="input-group-append">
							<button type="button" class="btn btn-success" id="request-addSchool-mdl" data-toggle="modal" data-target="#request-addSchool-modal"><i class="fa fa-plus-circle"></i></button>
						</div>
					</div>
					...
					<div class="input-group mt-2">
						...
						<div class="input-group-append">
							<button type="button" class="btn btn-success" id="request-addCourse-mdl" data-toggle="modal" data-target="#request-addCourse-modal"><i class="fa fa-plus-circle"></i></button>
						</div>
					</div>
					...
					<div class="input-group mt-2">
						...
						<div class="input-group-append">
							<button type="button" class="btn btn-success" id="request-addMajor-mdl"><i class="fa fa-plus-circle"></i></button>
						</div>
					</div>
					...
					<div class="input-group mt-2">
						...
						<input type="text" id="request-yrGrad" class="form-control col-md-5" maxlength="6" placeholder="Year Grad">
					</div>
