				...
				<div class="col-md-12">
					<form>
						<div class="input-group">
							...
							<input type="text" class="form-control" id="edit-description" maxlength="50">
						</div>
						...
						<div class="input-group mt-2">
							...
							<input type="text" class="form-control" id="edit-or-num" maxlength="15">
						</div>
						...
						<div class="input-group mt-2">
							...
							<input type="text" class="form-control" id="edit-amount-paid" maxlength="15">
						</div>
