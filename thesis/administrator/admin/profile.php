		...
		<div class="container-fluid" id="content">			
			<div class="row" style="margin-top: 5em;">
				<div class="col-md-8 offset-md-2">
					<div class="card" id="card-profile" data-id>
						...
						<div class="card-body">
							<form>
								<div class="row">
									<div class="col-md-8 offset-md-2">
										<div class="input-group">
											...
											<input type="text" class="form-control col-md-5" id="fname" placeholder="First name" disabled maxlength="20">
											<input type="text" class="form-control col-md-2" id="mi" placeholder="M.I" maxlength="2" disabled>
											<input type="text" class="form-control col-md-5" id="lname" disabled maxlength="20" placeholder="Last name">
										</div>
										<div><center><div id="update-name-msg"></div></center></div>
										<!--
									...
									-->
										...
										<div><center><div id="update-password-msg"></div></center></div>

										<center>
											<div class="form-check">
											  	<input class="form-check-input" type="checkbox" value="" id="showpassword" disabled>
								...
								<div class="row mt-4">
									<div class="col-md-4 offset-md-4" id="editProfile-wrapper">
										<center>
											<button class="btn btn-success edit" id="editProfile"><i class="fa fa-edit fa-fw"></i>Edit</button>
										</center>
									</div>
								</div>
							</form>
