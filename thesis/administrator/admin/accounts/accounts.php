...
<body>
	<div class="wrapper">
           	...
           	<ul class="list-unstyled components">
           		...
           		<?php 
           			if($_SESSION["username"]=="admin"){
           				echo '<li class="active"><a href="#"><i class="fa fa-cog"></i> Manage Accounts</a></li>';
           			}
           		?>
           		<li>
		...
		<div class="container-fluid" id="content">
							...
							<div class="input-group"  style="margin-top: 1em;">
								<div class="input-group-prepend">
									...
									<div class="dropdown-menu">
										<a href="#" class="dropdown-item" id="searchBy-username">Username</a>
										<a href="#" class="dropdown-item" id="searchBy-firstname">First name</a>
										<a href="#" class="dropdown-item" id="searchBy-lastname">Last name</a>
									</div>
								</div>
			...
			<div class="row mt-2">
				<div class="col-md-8 offset-md-2">
					<center><button class="btn btn-success" id="createAccount-toggle-modal"><i class="fa fa-plus-circle fa-fw"></i>Create Account</button></center>
				</div>
			</div>
		...
		<?php 
			include "modals/create-account-mdl.php";
			include "modals/edit-account-mdl.php";
		?>
