...
<body>
	<div class="wrapper">
								...
								<div class="input-group mb-2">
									<div class="input-group-prepend">
										...
										<div class="dropdown-menu">
											...
											<a class="dropdown-item" id="searchBy-name" href="#">Requisitioner</a>
						...
						<div class="col-md-12" id="schedule-table-wrapper">
							<table class="table table-hover table-bordered" id="tableSched">
								<thead class="bg-dark text-white">
									...
									<th id="firstActions" colspan="2">Actions</th>
								</thead>
								<tbody id="tbodySched">
		...
		<?php 
			...
			include "modals/vw-Function-Schedule-mdl.php";
			include "modals/vw-requests-mdl.php";
			include "modals/create-request-mdl.php";
			include "modals/vw-reject-mdl.php";
