								...
								<div class="input-group mb-2">
									<div class="input-group-prepend">
										...
										<div class="dropdown-menu">
											...
											<a class="dropdown-item" id="searchBy-name-reject" href="#">Requisitioner</a>
					...
					<div class="col-md-12" id="schedule-table-wrapper">
						<table class="table table-hover table-bordered" id="tableSched-reject">
							<thead class="bg-dark text-white">
								...
								<th id="rejectStart">Date & Time(start)</th>
								<th id="rejectEnd">Date & Time(end)</th>
								<th id="rejectRequisitioner">Requisitioner</th>
