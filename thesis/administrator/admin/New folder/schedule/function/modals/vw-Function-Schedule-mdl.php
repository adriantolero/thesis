		...
		<div class="modal-content bg-dark text-white">
			...
			<div class="modal-body">
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control" id="vwAgency" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control" id="vwAddress" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-12" id="vwTitle" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-2" id="vwParticipants" disabled>
				</div>
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="vwDatestart" disabled>
						</div>
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="vwTimestart" disabled>
						</div>	
				...
				<div class="row mb-2">
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="vwDateend" disabled>
						</div>
					...
					<div class="col-md-6">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="vwTimeend" disabled>
						</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control" id="vwNature" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-12" id="vwReservedBy" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-12" id="vwReservedByAddress" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-12" id="vwReservedByMobile" disabled>
				</div>
				...
				<div class="input-group mb-2">
					...
					<input type="text" class="form-control col-md-12" id="vwReservedByEmail" disabled>
				</div>
