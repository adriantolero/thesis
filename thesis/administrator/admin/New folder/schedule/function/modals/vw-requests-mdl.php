								...
								<div class="input-group mb-2">
									<div class="input-group-prepend">
										...
										<div class="dropdown-menu">
											...
											<a class="dropdown-item" id="searchBy-name-request" href="#">Requisitioner</a>
					...
					<div class="col-md-12" id="schedule-table-wrapper">
						<table class="table table-hover table-bordered" id="tableSched-request">
							<thead class="bg-dark text-white">
								...
								<th id="requestStart">Date & Time(start)</th>
								<th id="requestEnd">Date & Time(end)</th>
								<th id="requestRequisitioner">Requisitioner</th>
								<th id="requestDateReserved">Date requested</th>
								<th id="requestTimeLeft">Time remaining</th>
								<th id="requestActions" colspan="2">Actions</th>
							</thead>
