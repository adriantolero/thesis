			...
			<div class="modal-body">
				<form>
					...
					<div class="row mb-2">
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="create-date-start" placeholder="yyyy-mm-dd">
							</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="create-time-start" placeholder="HH:mm">
							</div>	
					...
					<div class="row mb-2">
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="create-date-end" placeholder="yyyy-mm-dd">
							</div>
						...
						<div class="col-md-6">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="create-time-end" placeholder="HH:mm">
							</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="create-reviewFee-vsu" class="form-control" placeholder="0">
					</div>
					...
					<div class="input-group mb-2">
						...
						<input type="text" id="create-reviewFee-nonVsu" class="form-control" placeholder="0">
					</div>
