...
<body>
	<div class="wrapper">
           		...
           		<li class="active">
           			...
           			<ul class="collapse show" id="venue-collapse">
           				...
           				<li class="list-unstyled components">
           					...
           					<ul class="collapse show" id="venue-manage-collapse">
           						<li class="list-unstyled components">
           							<a href="#"><span class="ml-4"><i class="fa fa-money-bill-alt fa-fw"></i>Rates</span></a>
           						</li>
           					</ul>
           				</li>
           			</ul>
		...
		<div class="container-fluid" id="content">	
			...
			<div class="row">
				<div class="col-md-10 offset-md-1">
					<center><h3>Venue Rates</h3></center>
				</div>
			</div>	
			
			<div class="row">
				<div class="col-md-10 offset-md-1" style="height: 400px;overflow-y: auto;">
					<table class="table table-hover table-bordered"> 
						<thead class="bg-dark text-white">
							...
							<th style="text-align: center;width: 16.67%" colspan="2">Action</th>
						</thead>
						<tbody id="tbodyRates">
		...
		<?php
			...
			include "../modals/rates/view-rate-mdl.php";
...
<script type="text/javascript" src="../../../scripts/functionRates.js"></script>
<script>
