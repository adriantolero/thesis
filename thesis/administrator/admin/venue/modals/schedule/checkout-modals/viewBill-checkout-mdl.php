...
<div class="modal fade" id="viewBill-checkout-modal" data-id tabindex="-1" role="dialog" aria-labelledby="Generate Bill for Check-out" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		...
		<div class="modal-content">
			<form>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row mb-2">
								...
								<div class="col-md-5">
									<input type="text" class="form-control" id="generateBill-checkin" disabled>
								</div>
							</div>
							...
							<div style="margin-top: 2em;">
								<div class="row mb-2">
									<label for="generateBill-particular" class="col-form-label col-md-3">Particular fee</label>
									<div class="col-md-5">
								...
								<div class="row mb-2">
									<label for="generateBill-amenity" class="col-form-label col-md-3">Amenity fee</label>
									<div class="col-md-5">
								...
								<div class="row mb-2">
									<label for="generateBill-total" class="col-form-label col-md-3">Total fee</label>
									<div class="col-md-5">
								...
								<div class="collapse" id="collapse-generateBill-ORNum">
									<div class="row mb-2">
										<label for="generateBill-ORNum" class="col-form-label col-md-3">Official Receipt #</label>
										<div class="col-md-5">
											<input type="text" class="form-control" id="generateBill-ORNum">
										</div>
									</div>
								</div>
				...
				<div class="modal-footer">							
					<button class="btn btn-success" id="generateBill-submit"><i class="fa fa-sign-out-alt"></i> Check-out</button>
				</div>
			</form>
		</div>
	</div>
