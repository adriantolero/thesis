...
<div class="modal fade" id="createBill-checkin-modal" data-id tabindex="-1" role="dialog" aria-labelledby="Settle checkin" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content bg-dark text-white">
			<form>
				<div class="modal-header">
					<h3 class="modal-title">
						<i class="fa fa-sign-out-alt"></i> Check-in
					</h3>
				...
				<div class="modal-body">
					...
					<div class="input-group mb-2">
						...
						<select class="custom-select" id="checkIn-particulars-category">
					...
					<div class="input-group mb-2">
						...
						<select class="custom-select" id="checkIn-particulars-aircon">
					...
					<div class="input-group mb-2">
						...
						<select class="custom-select" id="checkIn-particulars-description">
					...
					<div class="input-group mb-2">
						...
						<input type="text" class="form-control" id="checkIn-firstHour" disabled>
					</div>
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" id="checkIn-succeedingHour" disabled>
					</div>


				</div>
				<div class="modal-footer">							
					<button class="btn btn-success" id="checkIn-Submit" style="width: 100%;"><i class="fa fa-sign-in-alt"></i> Check-in</button>
				</div>
			</form>
		</div>
	</div>
